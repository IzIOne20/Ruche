...
if($_SESSION['role'] == 'Visiteur') // si c'est un apiculteur ou un visiteur il ne peut pas voir la page
{
...
<head>
    ...
    <!-- ajout du style du tableau visiteurs -->
    <link rel="stylesheet" href="../CSS/styleTableauVisit.css">
    ...
    <!-- ajout de la librairie font awesome pour ajouter des icones -->
    <script src="https://kit.fontawesome.com/3fc2be6b13.js" crossorigin="anonymous"></script>
    <!-- ajout de la librairie sweet alert pour les alertes dynamiques -->
...
<body>
    ...
    <a href="formApi.php">Ajouter un stagiaire</a>

    <?php 
    
    $sql = "SELECT idMembre, nom, prenom, mel, identifiant, numTelephone, role FROM membre WHERE role = 'Visiteur'";
